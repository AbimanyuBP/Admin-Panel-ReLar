...
Route::post('/users/store', [UsersController::class, 'store'])->middleware(['auth', 'verified'])->name('storeuser');
...
Route::post('/products/store', [ProductsController::class, 'store'])->middleware(['auth', 'verified'])->name('storeproduct');
